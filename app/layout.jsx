...
export const metadata = {
  ...
  description: `${DOCTOR.name} is a Consultant Pediatrician & Neonatologist with 12+ years of experience. Visit ${CLINIC.name} in RT Nagar, Bengaluru for newborn care, growth monitoring, pediatric nutrition and IBCLC lactation support.`,
  keywords: [
    'pediatrician RT Nagar',
    'pediatrician Bangalore',
    'child specialist RT Nagar',
    'neonatologist Bangalore',
    'lactation consultant Bangalore',
    'IBCLC Bangalore',
